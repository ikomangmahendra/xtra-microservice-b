...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("xtraMicroserviceB");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("xtraMicroserviceB");
        ...
        config.getMapConfigs().put("com.xtramile.myapp2.domain.*", initializeDomainMapConfig(jHipsterProperties));
